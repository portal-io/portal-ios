...
@implementation WVRLiveListReformer
...
- (NSArray<WVRLiveItemModel*> *)reformData:(NSDictionary *)data {
    ...
    NSArray<WVRHttpLiveDetailModel*> *models = [NSArray<WVRHttpLiveDetailModel*> yy_modelWithDictionary:businessDictionary];
    
    NSMutableArray * results = [[NSMutableArray alloc] init];
    
    for (WVRHttpLiveDetailModel * item in models) {
        WVRLiveItemModel * cur = [self parseLiveDetail:item];
