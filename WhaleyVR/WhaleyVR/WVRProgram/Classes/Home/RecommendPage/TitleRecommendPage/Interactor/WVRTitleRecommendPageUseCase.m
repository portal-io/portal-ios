...
@implementation WVRTitleRecommendPageUseCase
...
- (RACSignal *)buildUseCase {
    return [[[self.requestApi.executionSignal map:^id _Nullable(WVRNetworkingResponse *  _Nullable value) {
        WVRRecommendPageModel* result = [self.requestApi fetchDataWithReformer:[[WVRRecommendPageTitleReformer alloc] init]];
        return result;
