//
//  WVRPlayerVRFootballBottomView.m
//  WhaleyVR
//
...
#import "WVRPlayerVRFootballBottomView.h"
#import "WVRCameraChangeButton.h"

@interface WVRPlayerVRFootballBottomView ()
@property (nonatomic, strong) NSArray *cameraStandBtns;
@end

@implementation WVRPlayerVRFootballBottomView
