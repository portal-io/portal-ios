...
@implementation WVRAppEnterReport2UseCase
- (void)initRequestApi {
    self.requestApi = [[WVRHttpAppEnter2 alloc] init];
}
...
- (NSDictionary *)paramsForAPI:(WVRAPIBaseManager *)manager {
    ...
    // ip
    NSString *ip = [WVRDeviceModel deviceIPAdress];
    //time
